...
-- import Org.Types
-- import Org.Walk (walkM, query)
-- import Relude.Extra.Map (lookup)
-- import Site.Org.Common (walkOrgInContextM)
-- import System.FilePath (makeRelative, takeExtension, (</>), normalise)
...
--         tell (one (fp, lm))
--       lift $ logDebugNS "findFileAndInclude" $ toText fp
...
--             findAndInclude (normalise $ relDir </> toString fp)
--       l -> pure l

-- hasAttachLink :: a -> Bool
